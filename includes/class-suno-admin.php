        ...
        <div class="wrap">
            ...
            <div class="suno-stats-overview">
                <div class="suno-stat-box">
                    ...
                    <p class="suno-stat-number"><?php echo number_format($total_tracks); ?></p>
                </div>
                
                <div class="suno-stat-box">
                    <h3>Total des lectures</h3>
                    <p class="suno-stat-number"><?php echo number_format($total_plays); ?></p>
                </div>
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="suno_player_settings[allow_downloads]" value="1" 
                                <?php checked(get_option('suno_player_settings')['allow_downloads'] ?? false, 1); ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="suno_player_settings[autoplay]" value="1" 
                                <?php checked(get_option('suno_player_settings')['autoplay'] ?? false, 1); ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="suno_player_settings[default_theme]">
                                <option value="dark" <?php selected(get_option('suno_player_settings')['default_theme'] ?? 'dark', 'dark'); ?>>Sombre</option>
                                <option value="light" <?php selected(get_option('suno_player_settings')['default_theme'] ?? 'dark', 'light'); ?>>Clair</option>
                            </select>
                        </td>
                    </tr>
